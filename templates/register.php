			...
			<?php if( ! is_user_logged_in() ) { ?>
				...
				<fieldset class="rcp_user_fieldset">
						...
						<div id="rcp_user_email_wrap" class="form-group row">
								<label class="col-md-3 col-form-label col-form-label-lg" for="rcp_user_email"><?php echo apply_filters ( 'rcp_registration_email_label', __( 'Email', 'rcp' ) ); ?></label>
								<div class="col-md-9">
						...
						<div id="rcp_user_first_wrap" class="form-group row">
								<label class="col-md-3 col-form-label col-form-label-lg" for="rcp_user_first"><?php echo apply_filters ( 'rcp_registration_firstname_label', __( 'First Name', 'rcp' ) ); ?></label>
								<div class="col-md-9">
						...
						<div id="rcp_user_last_wrap" class="form-group row">
								<label class="col-md-3 col-form-label col-form-label-lg" for="rcp_user_last"><?php echo apply_filters ( 'rcp_registration_lastname_label', __( 'Last Name', 'rcp' ) ); ?></label>
								<div class="col-md-9">
						...
						<div id="rcp_password_wrap" class="form-group row">
								<label class="col-md-3 col-form-label col-form-label-lg" for="rcp_password"><?php echo apply_filters ( 'rcp_registration_password_label', __( 'Password', 'rcp' ) ); ?></label>
								<div class="col-md-9">
						...
						<div id="rcp_password_again_wrap" class="form-group row">
								<label class="col-md-3 col-form-label col-form-label-lg" for="rcp_password_again"><?php echo apply_filters ( 'rcp_registration_password_again_label', __( 'Password Again', 'rcp' ) ); ?></label>
								<div class="col-md-9">
